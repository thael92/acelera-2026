    ...
    <section id="social-proof" className="py-24 bg-theme-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center mb-24 relative">
          ...
          <div className="lg:col-span-12 w-full flex justify-center items-center relative py-10">
            <div className="relative bg-theme-surface border border-theme-purple/50 rounded-3xl p-4 shadow-[0_0_0_rgba(147,51,234,0.3)]">
              <img
                src="img/pessoas-segredo.png"
                alt="Team"
                className="block mx-auto relative w-[340px] h-[340px] md:w-[600px] md:h-[500px] lg:w-[1000px] lg:h-[650px] object-cover rounded-2xl"
              />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto px-4 lg:px-0">
          {[1, 2, 3].map((_, idx) => (
